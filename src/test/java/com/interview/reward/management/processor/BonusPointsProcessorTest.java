...
public class BonusPointsProcessorTest {
    ...
    void setUp() {
        ...
        bonusPointsProcessorConfiguration.setSecondStageMultiplier(BigDecimal.valueOf(2L));
        bonusPointsProcessorConfiguration.setFirstStage(BigDecimal.valueOf(50));
        bonusPointsProcessorConfiguration.setSecondStage(BigDecimal.valueOf(100));
